...
class _SplashScreenState extends State<SplashScreen> with TickerProviderStateMixin{
  ...
  deployanimation() {
    tweencontroller=AnimationController(vsync: this,duration: Duration(seconds: 5));
    ...
    return Scaffold(
      ...
      body: Container(
        ...
        child:  Column(
              ...
              children: [
                SvgPicture.asset("assets/images/exohealhands.svg",
                  width: screenwidth,),
                Container(
...
//                      top: 80
                  ...
                  child: Center(
                    child: Text("ExoHeal",style: TextStyle(
...
//                      top: 15
                  ...
                  child: Center(
                    child: Text("Retraining your brain with Robots",
