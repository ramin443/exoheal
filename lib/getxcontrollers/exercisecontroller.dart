     ...
     //             height: 6,width: 6,
          ...
          //            right: 5
                  ...
                  decoration: BoxDecoration(
                    ...
                    color: currentscrollviewindex==0?darkgrey:Color(0xffDDDDDD),
                  ),
                ),
                AnimatedContainer(duration: Duration(milliseconds: 150),
   //               height: 6,width: 6,
                  ...
                  decoration: BoxDecoration(
                    shape: BoxShape.circle,
                    color:currentscrollviewindex==1?darkgrey: Color(0xffDDDDDD),
                  ),
                ),
                AnimatedContainer(duration: Duration(milliseconds: 150),
  //                height: 6,width: 6,
                  ...
                  decoration: BoxDecoration(
                    shape: BoxShape.circle,
                    color:currentscrollviewindex==2?darkgrey: Color(0xffDDDDDD),
                  ),
                ),
                AnimatedContainer(duration: Duration(milliseconds: 150),
//                  height: 6,width: 6,
                  ...
                  decoration: BoxDecoration(
                    shape: BoxShape.circle,
                    color: currentscrollviewindex==3?darkgrey:Color(0xffDDDDDD),
                  ),
                ),
